...
class ModelServe:
    ...
    def _init_(self):
        ...
        self.model_loaded1=pickle.load(open('KNN_model','rb'))
        self.model_loaded2=pickle.load(open('KNN_model2','rb'))
    ...
    def predict(self, request):
        ...
        a=self.model_loaded1.predict(pd.DataFrame([[1.590251,-0.457010,1.237621,0.124644,0.827392]],columns=['network_traffic','power_consumption','num_executed_instructions','execution_time','energy_efficiency']))
        b=self.model_loaded2.predict(pd.DataFrame([[1.590251,-0.457010,1.237621,0.124644,0.827392]],columns=['network_traffic','power_consumption','num_executed_instructions','execution_time','energy_efficiency']))
